        ...
        <>
          ...
          <div className="glass-card p-6 rounded-2xl border border-outline-variant/15 relative overflow-hidden">
            ...
            {forecastData.length === 0 ? (
              <EmptyState title="No forecast metrics available" message="Forecast telemetry will update once telemetry history collects initial data points." />
            ) : (
          ...
          {/* Section 2: Carbon Breakdown Card */}
          ...
          <div className="glass-card p-6 rounded-2xl border border-outline-variant/15">
            ...
            {historicalTrends.length === 0 ? (
              <EmptyState title="No historical trend data yet" message="Historical billing records will accumulate over time." />
            ) : (
              <div className="h-72 w-full">
                <ResponsiveContainer width="100%" height="100%">
